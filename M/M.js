...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const source = document.querySelector(".sildeshow");
    const roott = document.documentElement

    function updateHeight() {
        let sourceHeight = source.offsetHeight = "px";
        root.style.setProperty("--source-height", sourceHeight)
    }
